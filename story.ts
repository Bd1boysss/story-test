...
export const WIP_TOKEN_ADDRESS = "0x1514000000000000000000000000000000000000"; // whitelisted WIP on mainnet
export const ROYALTY_POLICY_LAP = "0xBe54FB168b3c982b7AaE60dB6CF75Bd8447b390E"; // LAP policy on mainnet
...
export function getStoryClient() {
  ...
  const config: StoryConfig = {
    account,
    transport: http(rpc),
    chainId: 1514, // Story mainnet per docs
  };
